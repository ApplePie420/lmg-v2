...
module.exports = function(app) {
    ...
    app.post('/registerUser',
        connectEnsureLogin.ensureLoggedIn('/?info=Only registered users can invite others'), (req, res, next) => {
            try {
     ...
     */
    app.get('/logout',
        connectEnsureLogin.ensureLoggedIn('/error?err=You must be logged in to log out xD'), (req, res) => {
            req.logOut();
