...
module.exports = function(app) {
    ...
    */
    app.post('/api/changelog/saveChangelog',
        connectEnsureLogin.ensureLoggedIn('/?error=You don\'t have rights to do this.'), (req, res) => {
            // split incoming text from textarea by newlines
            const newChanges = req.body.changesArea.split('\r\n');
    ...
    */
    app.get('/nmapReportExists', connectEnsureLogin.ensureLoggedIn(errorRoute), (req, res) => {
        // get the SSID
        // TODO: instead of SSID, make this based on MAC
        const xmlQuery = req.query.SSID;
    ...
    */
    app.get('/nmapReportsList', connectEnsureLogin.ensureLoggedIn(errorRoute), (req, res) => {
        // TODO: instead of SSID, make this based on MAC
        // query wifi info collection for SSID
        MongoClient.connect(mongoURI, function(err, db) {
            // display error message and throw err
    ...
    */
    app.post('/api/uploadXML', connectEnsureLogin.ensureLoggedIn(errorRoute), (req, res) => {
        // TODO: instead of SSID, make this based on MAC
        // construct database object from req
        const fileUploading = req.files.filename;
        const fileData = fileUploading.data;
    ...
    */
    app.post('/api/editWPS', connectEnsureLogin.ensureLoggedIn(errorRoute), (req, res) => {
